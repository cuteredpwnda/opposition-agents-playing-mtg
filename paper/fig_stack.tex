...
\begin{tikzpicture}[
  ...
  % ---- data -> symbolic ------------------------------------------------
  % Each data box connects to the WEST anchor of the symbolic box on its
  % row’s side: top two go into KG, bottom two go into the engine.
  ...
  % start ON the upper-east edge of the engine box, run east into the
  % gap, up to the top bus, across, and down into the agent zoo.
  \draw[flow]
      ([yshift= 0.2cm]eng.east) -- (7.2, 0.2)
      -- (7.2, 4.6) -- (14.0, 4.6)
  ...
  % across, up the gap, and INTO the lower-east edge of the engine box.
  \draw[backflow]
      (a6.south) -- (14.0,-4.6)
      -- (7.2,-4.6)
      node[elabel, pos=0.55, below=1pt]{action}
      -- (7.2,-0.2)
      -- ([yshift=-0.2cm]eng.east);
