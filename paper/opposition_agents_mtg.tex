...
\begin{tikzpicture}[
  ...
  % ---- data -> symbolic -----------------------------------------------
  \draw[flow] (scry.east)  -- ([yshift= 0.6cm]kg.west)
              node[elabel, pos=0.55]{cards};
  \draw[flow] (sb.east)    -- ([yshift=-0.6cm]kg.west)
              node[elabel, pos=0.55]{combos};
  \draw[flow] (rules.east) -- ([yshift= 0.6cm]eng.west)
              node[elabel, pos=0.55]{rules};
  \draw[flow] (decks.east) -- ([yshift=-0.6cm]eng.west)
              node[elabel, pos=0.55]{game cfg};
  ...
  % ---- engine <-> agent loop, routed in the gap and along far buses ---
