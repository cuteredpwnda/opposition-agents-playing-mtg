...
agent_aggro = MTGAgentLLM("Aggressive", strategy="aggressive", ollama_model="gemma4:e2b")
agent_control = MTGAgentLLM("Control", strategy="control", ollama_model="gemma4:e2b")
